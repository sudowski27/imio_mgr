"""version 0.1.0"""
import pytest
from variational_autoencoder.src.validate_configuration import validate_test_dataset_file
...
def test_0():
    ...
    validate_test_dataset_file(configure_dict)
