...
def test_0():
    ...
    count_unique_channel_lengths_expected = 4
    args = CreateCsvTrainDatasetFileArguments(
        "text_csv.csv",
        5,
        count_unique_channel_lengths_expected,
        5,
        5,
        True
    )
    ...
    count_unique_channel_lengths_value = count_unique_channel_lengths(first_device_dataframe)
    assert count_unique_channel_lengths_value == count_unique_channel_lengths_expected
