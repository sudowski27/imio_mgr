"""version 0.1.0"""
import pytest
from variational_autoencoder.src.validate_configuration import validate_synth_data_folder
...
def test_0():
    ...
    validate_synth_data_folder(configure_dict)
