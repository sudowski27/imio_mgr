"""version 0.1.0"""
import pytest
from variational_autoencoder.src.validate_configuration import validate_learning_rate
...
def test_0():
    ...
    validate_learning_rate(configure_dict)
