...
from variational_autoencoder.src.data_dimensions import (
    ...
    connect_devices,
    get_first_device,
    count_unique_drain_source_voltages
)
...
def test_0():
    ...
    count_unique_drain_source_voltages_expected = 20
    args = CreateCsvTrainDatasetFileArguments(
        "text_csv.csv",
        5,
        4,
        10,
        count_unique_drain_source_voltages_expected,
        True
    )
    ...
    count_unique_gate_source_voltages_value = count_unique_drain_source_voltages(first_device_dataframe)
    assert count_unique_gate_source_voltages_value == count_unique_drain_source_voltages_expected
