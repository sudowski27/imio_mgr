"""version 0.1.0"""
import pytest
from variational_autoencoder.src.validate_configuration import validate_trained_vae_file_name
...
def test_0():
    ...
    validate_trained_vae_file_name(configure_dict)
...
def test_1():
    ...
    create_configure_dict_kwargs = {
        "trained_vae_file_name_value": True
    }
...
def test_2():
    ...
    """
    create_configure_dict_kwargs = {
        "trained_vae_file_name_key": True
    }
    configure_dict = create_configure_dict(**create_configure_dict_kwargs)
    with pytest.raises(ValueError):
        validate_trained_vae_file_name(configure_dict)
